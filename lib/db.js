...
function mem() {
  ...
  _mem = {
    ...
    posts: [
      { id: 100, title: '三大铁律，驭鬼者生存的根基', summary: '鬼无法被杀死；能对付鬼的只有鬼；黄金能隔离鬼。', content: '在神秘复苏的世界里，有三条铁律：\n一、鬼无法被杀死。\n二、能对付鬼的，只有鬼。\n三、黄金能隔离鬼。', category: '驭鬼心得', author: '杨间', authorId: 1, createdAt: now - 1000*60*60*2, views: 8964, likes: 731 },
      { id: 101, title: '关于"敲门鬼"的情报', summary: '每敲一次门，就有一人消失。', content: '敲门鬼的规律是【敲门】。\n1. 不要应声。\n2. 远离门。\n3. 往黄金跑。', category: '鬼事实录', author: '鬼差猎人', authorId: 3, createdAt: now - 1000*60*60*5, views: 5210, likes: 402 },
      { id: 102, title: '关于"驭鬼"最容易死人的误区', summary: '驭鬼不是驯服，是互蚀。', content: '驭鬼不是驾驭，是"同生共死"。每用一次厉鬼的力量，它就复苏一分。', category: '规律情报', author: '守夜人', authorId: 2, createdAt: now - 1000*60*60*12, views: 12034, likes: 987 }
    ],
    comments: [
      { id: 1000, postId: 100, floor: 1, author: '守夜人',   content: '规矩没错。',         createdAt: now - 1000*60*60 },
      { id: 1001, postId: 100, floor: 2, author: '鬼差猎人', content: '还有第四条：别信人皮书。', createdAt: now - 1000*60*45 }
    ],
    sessions: new Map(),
    nextPostId: 103,
    nextCommentId: 1002
